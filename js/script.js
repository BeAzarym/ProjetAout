...
let bibliotheque = [{Nom: "Les 4 accords de Toltèques", Auteur: "Miguel Ruiz", Prix: 49.55, Annee: "1985", Genre: "Encyclopédie",Statut: true},
...
function sauvegardeDonne () {
    ...
    if(! checkData(bookCreator)){
        ...
        document.getElementById("collectionLivre").innerHTML = genererTable(bibliotheque);
    } else {alert("Le livre " + bookCreator.Nom + " est déja présent dans la bibliothèque.");}
}
